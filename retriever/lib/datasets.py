...
def datasets(keywords=None, licenses=None):
    ...
    if not keywords and not licenses:
        ...
        return dict({'online': online_retriever_script_names + online_script_names, 'offline': offline_scripts})
    ...
    return dict({'online': result_retriever_scripts_online + result_scripts_online, 'offline': result_scripts_offline})
